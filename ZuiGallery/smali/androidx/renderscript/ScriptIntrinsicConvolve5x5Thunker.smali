.class Landroidx/renderscript/ScriptIntrinsicConvolve5x5Thunker;
.super Landroidx/renderscript/ScriptIntrinsicConvolve5x5;
...
.method constructor <init>(ILandroidx/renderscript/RenderScript;)V
    ...
    .line 30
    invoke-direct {p0, p1, p2}, Landroidx/renderscript/ScriptIntrinsicConvolve5x5;-><init>(ILandroidx/renderscript/RenderScript;)V

    return-void
.end method

.method public static bridge synthetic create(Landroidx/renderscript/RenderScript;Landroidx/renderscript/Element;)Landroidx/renderscript/ScriptIntrinsicConvolve5x5;
    .locals 0
...
.method public static create(Landroidx/renderscript/RenderScript;Landroidx/renderscript/Element;)Landroidx/renderscript/ScriptIntrinsicConvolve5x5Thunker;
    .locals 3
    ...
    .line 37
    new-instance v1, Landroidx/renderscript/ScriptIntrinsicConvolve5x5Thunker;

    const/4 v2, 0x0

    invoke-direct {v1, v2, p0}, Landroidx/renderscript/ScriptIntrinsicConvolve5x5Thunker;-><init>(ILandroidx/renderscript/RenderScript;)V
    ...
    invoke-static {p0, p1}, Landroid/renderscript/ScriptIntrinsicConvolve5x5;->create(Landroid/renderscript/RenderScript;Landroid/renderscript/Element;)Landroid/renderscript/ScriptIntrinsicConvolve5x5;

    move-result-object p0

    iput-object p0, v1, Landroidx/renderscript/ScriptIntrinsicConvolve5x5Thunker;->mN:Landroid/renderscript/ScriptIntrinsicConvolve5x5;
    :try_end_0
...
.method public forEach(Landroidx/renderscript/Allocation;)V
    ...
    .line 66
    :try_start_0
    iget-object v0, p0, Landroidx/renderscript/ScriptIntrinsicConvolve5x5Thunker;->mN:Landroid/renderscript/ScriptIntrinsicConvolve5x5;

    invoke-virtual {p1}, Landroidx/renderscript/AllocationThunker;->getNObj()Landroid/renderscript/Allocation;

    move-result-object p1

    invoke-virtual {v0, p1}, Landroid/renderscript/ScriptIntrinsicConvolve5x5;->forEach(Landroid/renderscript/Allocation;)V
    :try_end_0
    .catch Landroid/renderscript/RSRuntimeException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getFieldID_Input()Landroidx/renderscript/Script$FieldID;
    ...
    .line 84
    invoke-virtual {p0, v0, v1}, Landroidx/renderscript/ScriptIntrinsicConvolve5x5Thunker;->createFieldID(ILandroidx/renderscript/Element;)Landroidx/renderscript/Script$FieldID;

    move-result-object v0

    .line 86
    :try_start_0
    iget-object v1, p0, Landroidx/renderscript/ScriptIntrinsicConvolve5x5Thunker;->mN:Landroid/renderscript/ScriptIntrinsicConvolve5x5;
...
.method public getKernelID()Landroidx/renderscript/Script$KernelID;
    ...
    .line 74
    invoke-virtual {p0, v0, v1, v2, v2}, Landroidx/renderscript/ScriptIntrinsicConvolve5x5Thunker;->createKernelID(IILandroidx/renderscript/Element;Landroidx/renderscript/Element;)Landroidx/renderscript/Script$KernelID;
...
.method bridge synthetic getNObj()Landroid/renderscript/Script;
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/renderscript/ScriptIntrinsicConvolve5x5Thunker;->getNObj()Landroid/renderscript/ScriptIntrinsicConvolve5x5;
...
.method public setInput(Landroidx/renderscript/Allocation;)V
    ...
    invoke-virtual {v0, p1}, Landroid/renderscript/ScriptIntrinsicConvolve5x5;->setInput(Landroid/renderscript/Allocation;)V
    :try_end_0
    .catch Landroid/renderscript/RSRuntimeException; {:try_start_0 .. :try_end_0} :catch_0

...
.source "ModalFragmentActivity.java"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lzui/appcompat/app/ModalFragmentActivity;->TAG:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lzui/appcompat/app/ModalFragmentActivity;->mDm:Landroid/util/DisplayMetrics;
...
.method private adjustActivityWidthAndGravity()V
    ...
    .line 193
    invoke-virtual {p0}, Lzui/appcompat/app/ModalFragmentActivity;->getWindow()Landroid/view/Window;
    ...
    .line 196
    iget v2, p0, Lzui/appcompat/app/ModalFragmentActivity;->mWidth:I

    iput v2, v1, Landroid/view/WindowManager$LayoutParams;->width:I

    .line 197
    iget v2, p0, Lzui/appcompat/app/ModalFragmentActivity;->mHeight:I
...
.method private updateToolbar()V
    ...
    .line 202
    iget-object v0, p0, Lzui/appcompat/app/ModalFragmentActivity;->mToolbar:Lzui/widget/SimpleToolbar;

    if-eqz v0, :cond_0

    .line 203
    iget v1, p0, Lzui/appcompat/app/ModalFragmentActivity;->mWidth:I
    ...
    invoke-virtual {p0}, Lzui/appcompat/app/ModalFragmentActivity;->getTitle()Ljava/lang/CharSequence;
    ...
    .line 207
    invoke-virtual {p0, v0}, Lzui/appcompat/app/ModalFragmentActivity;->onCreateOptionsMenu(Landroid/view/Menu;)Z
...
.method public finish()V
    ...
    invoke-virtual {p0, v0, v1}, Lzui/appcompat/app/ModalFragmentActivity;->overridePendingTransition(II)V
...
.method public getActivityHeight()I
    ...
    .line 157
    iget v0, p0, Lzui/appcompat/app/ModalFragmentActivity;->mHeight:I
...
.method public getActivityWidth()I
    ...
    .line 153
    iget v0, p0, Lzui/appcompat/app/ModalFragmentActivity;->mWidth:I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 42
    invoke-virtual {p0}, Lzui/appcompat/app/ModalFragmentActivity;->getResources()Landroid/content/res/Resources;
    ...
    .line 43
    invoke-virtual {p0}, Lzui/appcompat/app/ModalFragmentActivity;->isInMultiWindowMode()Z
    ...
    invoke-virtual {p0, v0}, Lzui/appcompat/app/ModalFragmentActivity;->setTheme(I)V
    ...
    .line 50
    invoke-virtual {p0, p1}, Lzui/appcompat/app/ModalFragmentActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/view/WindowManager;

    iput-object p1, p0, Lzui/appcompat/app/ModalFragmentActivity;->mWindowManager:Landroid/view/WindowManager;
    ...
    iget-object v0, p0, Lzui/appcompat/app/ModalFragmentActivity;->mDm:Landroid/util/DisplayMetrics;

    invoke-virtual {p1, v0}, Landroid/view/Display;->getMetrics(Landroid/util/DisplayMetrics;)V

    .line 52
    iget-object p1, p0, Lzui/appcompat/app/ModalFragmentActivity;->mDm:Landroid/util/DisplayMetrics;
    ...
    iput p1, p0, Lzui/appcompat/app/ModalFragmentActivity;->mWidth:I
    ...
    iput p1, p0, Lzui/appcompat/app/ModalFragmentActivity;->mHeight:I

    .line 55
    invoke-virtual {p0, v1}, Lzui/appcompat/app/ModalFragmentActivity;->requestWindowFeature(I)Z
    ...
    invoke-virtual {p0, p1, v0}, Lzui/appcompat/app/ModalFragmentActivity;->overridePendingTransition(II)V
    ...
    invoke-virtual {p0, p1}, Lzui/appcompat/app/ModalFragmentActivity;->findViewById(I)Landroid/view/View;

    move-result-object p1

    check-cast p1, Landroid/widget/FrameLayout;

    iput-object p1, p0, Lzui/appcompat/app/ModalFragmentActivity;->mContent:Landroid/widget/FrameLayout;
    ...
    iput-object p1, p0, Lzui/appcompat/app/ModalFragmentActivity;->mToolbar:Lzui/widget/SimpleToolbar;

    .line 65
    invoke-direct {p0}, Lzui/appcompat/app/ModalFragmentActivity;->updateToolbar()V
...
.method public onMenuItemClick(Landroid/view/MenuItem;)Z
    ...
    .line 131
    invoke-virtual {p0, p1}, Lzui/appcompat/app/ModalFragmentActivity;->onOptionsItemSelected(Landroid/view/MenuItem;)Z
...
.method protected onResume()V
    ...
    .line 85
    invoke-direct {p0}, Lzui/appcompat/app/ModalFragmentActivity;->adjustActivityWidthAndGravity()V
...
.method public setContentView(I)V
    ...
    .line 96
    iget-object v0, p0, Lzui/appcompat/app/ModalFragmentActivity;->mContent:Landroid/widget/FrameLayout;
    ...
    iget-object v1, p0, Lzui/appcompat/app/ModalFragmentActivity;->mContent:Landroid/widget/FrameLayout;
...
.method public showHomeAsUpIndicator(Z)V
    ...
    .line 182
    iget-object p1, p0, Lzui/appcompat/app/ModalFragmentActivity;->mToolbar:Lzui/widget/SimpleToolbar;

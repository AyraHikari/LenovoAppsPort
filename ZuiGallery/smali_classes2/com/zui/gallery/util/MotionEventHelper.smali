.class public final Lcom/zui/gallery/util/MotionEventHelper;
...
.method public static transformEvent(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
    ...
    .line 34
    sget-boolean v0, Lcom/zui/gallery/common/ApiHelper;->HAS_MOTION_EVENT_TRANSFORM:Z

    if-eqz v0, :cond_0

    .line 35
    invoke-static {p0, p1}, Lcom/zui/gallery/util/MotionEventHelper;->transformEventNew(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
    ...
    .line 37
    :cond_0
    invoke-static {p0, p1}, Lcom/zui/gallery/util/MotionEventHelper;->transformEventOld(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
...
.method private static transformEventOld(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
    ...
    .line 54
    invoke-static/range {p0 .. p0}, Lcom/zui/gallery/util/MotionEventHelper;->getPointerIds(Landroid/view/MotionEvent;)[I

    move-result-object v7

    .line 55
    invoke-static/range {p0 .. p0}, Lcom/zui/gallery/util/MotionEventHelper;->getPointerCoords(Landroid/view/MotionEvent;)[Landroid/view/MotionEvent$PointerCoords;
    ...
    invoke-static {v0, v14}, Lcom/zui/gallery/util/MotionEventHelper;->transformAngle(Landroid/graphics/Matrix;F)F
